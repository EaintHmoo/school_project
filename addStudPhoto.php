...
<?php 
        ...
        if(!empty($name) && !empty($year)&&!empty($exam_no) && !empty($distinction)&& !empty($photo))
        {
            ...
            $result = $studPhoto->addPhoto($name,$year,$exam_no,$distinction,$remark,$photo);
            if($result)
            {
...
<h1 class="h3 my-4 font-weight-normal text-center">ကျောင်းသားဟောင်းပုံအသစ်ထည့်ခြင်း</h1>
<form method="post" enctype="multipart/form-data" class="form-signin p-3" method="post" style="border:2px solid black;padding:5px;border-radius:5px" >
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-9">
        <input type="text" class="form-control" id="name" value="<?php if(isset($caption)) echo $caption;?>" name="name">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-9">
        <img src="img/placeholder2.png" class="form-control" id="studPhotoDisplay"/>
        <input type="file" id="studPhoto" onchange="displayStudPhoto(this)" style="display: none;"  name="photo" accept="image/*">
