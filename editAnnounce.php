...
<?php 
        ...
        $result = $announce->showAnnounceOneRow($id);
        ...
        if(isset($_POST["submit"]))
        {
            ...
            if(empty($_FILES['announcePhoto']['name']))
            {
        ...
        {
            $announce = new AnnounceController();
            $result = $announce->editAnnounce($id,$title,$description,$date,$photo);
            if($result)
            {
...
<h1 class="h3 my-4 font-weight-normal text-center">အကြောင်းကြားလွှာပြုပြင်ခြင်း</h1>
...
<div class="row mb-3">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-9">
        <img src="upload/announce/<?php echo $result[0]['photo_dir'];?>" class="form-control" id="announceEditPhotoDisplay"/>
        <input type="file" id="announceEditPhoto" onchange="displayAnnunceEditImage(this)" style="display: none;"  name="announcePhoto" accept="image/*">
